"""
Django settings for droughtProject project.
...
SECRET_KEY = 'django-insecure-(3rbwskk%g#c5s(@%&1&r2pe*r+k**+2izq4h=+s2q-$1g4s)0'
...
INSTALLED_APPS = [
    'droughtApp.apps.DroughtappConfig',
...
ROOT_URLCONF = 'droughtProject.urls'
